...
namespace FastMarketBackEnd.services
{
    public class TokensService
    {
        ...
        public TokensService(ApplicationContext db, ILogger<TokensService> logger)
        {
            this.db = db;
            this.logger = logger;
        }
            ...
            UserAgentData userAgentData)
        {
            ...
            if (userToken is not null)
            {
                ...
                userToken.Expired = now.AddMonths(userToken.LifeTime);
            ...
            else
            {
                ...
                await this.db.UsersAgent.AddAsync(new UserAgent { Token = token.Entity, OS = userAgentData.OS, Browser = userAgentData.Browser });
        ...
        public async Task<UserDataAlt?> RefreshAsync(
            TokensData tokens,
            UserAgentData userAgentData)
        {
